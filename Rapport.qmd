...
8 forsøkspersoner er et lite utvalg når vi skal måle reliabiliteten til en test [hopkins]. Ved første test var VO$_{2maks}$ på 66,2 +- 7,2 ml/kg/min, noe som gjør at de kan defineres som godt trente. Godt trente utøvere vil de også produsere høyere watt verdier. Her ser vi at med bakgrunn i de høyere verdiene, vil vi få ett større standaravvik som er noe som vi kan forvente ettersom vi har bedre forsøkspersoner. (Hopkin
...
Det ble også kjørt kalibrering av oxycon pro før hver test, og vi satte godkjent kalibrering på volum til ± 1 %, og godkjent kalibrering av gass med en feilmargin på maksimalt ± 1.0 %.
